...
class MapsFragment : Fragment(),
    ...
    private fun placeToiletMarkers() {
        toiletViewModel.getToilets().observe(viewLifecycleOwner, Observer { toiletsSnapshot ->
     ...
     */
    override fun rateToilet(currentUser: User, toilet: Toilet, rating: Float) {
        toiletViewModel.rateToilet(currentUser, toilet, rating)
    }
