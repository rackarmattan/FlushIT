...
/**
 * Dialog class that displays a toilet that the user has clicked on. Creates the toilet_dialog.xmlml.
 */
...
class ToiletDialog : AppCompatDialogFragment() {
    ...
    interface ToiletDialogListener{
         ...
         */
        fun rateToilet(currentUser: User, toilet:Toilet, rating: Float)
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return activity?.let {
            ...
            val view = it.layoutInflater.inflate(R.layout.toilet_dialog, null)
    ...
    private fun rateToilet(ratingBar: RatingBar, rating: Float, fromUser: Boolean) {
        if (fromUser) {
            ...
            listener.rateToilet(currentUser, toilet, rating)
