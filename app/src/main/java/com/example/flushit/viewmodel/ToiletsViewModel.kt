...
//    private val toilets = MutableLiveData<DataSnapshot>()
//
//    init {
//        loadToilets()
//    }
...
//        toilets.value = repository.getToilets().value
//    }
//
//    fun testGetToilets() = toilets as LiveData<DataSnapshot>
     ...
     * adds the new grade to that. Then recalculates the average grade that this toilet has. Update
...
//    }
    ...
    fun rateToilet(userThatRated: User, toiletToRate: Toilet, grade: Float){
        toiletToRate.nrOfRaters++
        toiletToRate.totalRating += grade
        toiletToRate.averageRating = toiletToRate.totalRating / toiletToRate.nrOfRaters
        updateToilet(toiletToRate)
        repository.rateToilet(userThatRated, toiletToRate, grade)
    }
